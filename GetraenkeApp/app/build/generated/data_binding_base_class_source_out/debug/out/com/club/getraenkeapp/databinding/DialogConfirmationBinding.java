...
public final class DialogConfirmationBinding implements ViewBinding {
  ...
  private DialogConfirmationBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView textViewIcon, @NonNull TextView textViewSummary,
  ...
  public static DialogConfirmationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogConfirmationBinding((MaterialCardView) rootView, textViewIcon,
          textViewSummary, textViewTitle);
    }
